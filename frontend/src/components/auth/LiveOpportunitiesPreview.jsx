...
export default function LiveOpportunitiesPreview() {
  return (
    <div className="rounded-xl border border-vantage-border bg-vantage-surface/80 p-4 backdrop-blur">
      <div className="flex items-center justify-between px-1 pb-3">
        <span className="text-[11px] font-medium uppercase tracking-wide text-vantage-textDim">
          Today's opportunities
        </span>
        <span className="flex items-center gap-1.5 text-[11px] font-semibold text-vantage-positive">
      ...
      <div className="flex flex-col gap-1.5">
        {previewRows.map((row) => (
          <div
            key={row.player}
            className="flex items-center justify-between gap-3 rounded-lg bg-vantage-surfaceAlt px-3 py-2.5"
          >
        ...
        <div className="mt-1.5 h-1 overflow-hidden rounded-full bg-vantage-surfaceAlt">
          <motion.div
